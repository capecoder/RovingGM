<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactReportResult.aspx.cs" Inherits="RovingGM.ContactReportResult" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView AlternatingRowStyle-BackColor="#DCDCDC" ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id" BorderStyle="Solid" CssClass="gridview1" SelectedRowStyle-BackColor="Yellow" OnPageIndexChanging="GridView1_PageIndexChanging">
                <Columns>
                    ...
                    <asp:BoundField DataField="VisitDate" DataFormatString="{0:MM/dd/yyyy}" HeaderText="Visit Date" SortExpression="VisitDate" />
                </Columns>
            </asp:GridView>
        </div>
        ...
        <div title="Contact Report Results">
            <asp:DetailsView ID="DetailsView1" runat="server" Height="121px" Width="323px" AutoGenerateRows="False" DataKeyNames="id" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
                ...
                <Fields>
                    ...
                    <asp:BoundField DataField="OverallConditions" HeaderText="Overall Business Conditions" SortExpression="OverallConditions" />
                    <asp:BoundField DataField="Improve" HeaderText="Improve Business" SortExpression="Improve" />
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:rovingGMConnectionString %>" SelectCommand="spSelectSingleVisit" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </div>
    </form>
